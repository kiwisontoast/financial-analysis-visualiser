...
# Dynamic sizing
root.geometry("")  # Remove fixed size
...
compare_2_check = ttk.Checkbutton(frame, text="Compare 2 Stocks", variable=compare_2_var, command=toggle_comparison_mode)
compare_3_check = ttk.Checkbutton(frame, text="Compare 3 Stocks", variable=compare_3_var, command=toggle_comparison_mode)
...
comparison_result_label.grid(row=9, column=0, columnspan=6, sticky=tk.W, pady=5)
comparison_result_label.grid_remove()
...
start_day, start_month, start_year = create_date_dropdowns(frame, 6, "Start Date:")
...
# Dynamic plot sizing
fig, ax = plt.subplots(figsize=(12, 6))  # Adjust initial size
fig.patch.set_facecolor('#333333')
ax.set_facecolor('#333333')
